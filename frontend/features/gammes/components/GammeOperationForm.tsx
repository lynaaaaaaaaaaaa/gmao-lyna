...
type GammeOperationFormProps = {
  ...
  error: string | null;
  success: string | null;
  setField: <K extends keyof GammeOperationFormProps['values']>(
    field: K,
    value: GammeOperationFormProps['values'][K],
  ) => void;
  onSubmit: (e: React.FormEvent<HTMLFormElement>) => void;
};

export default function GammeOperationForm({
  values,
  saving,
  error,
  success,
      ...
      >
        <div className="mb-5">
          ...
          <p className="mt-1 text-[13px]" style={{ color: '#6B8596' }}>
            Ajoute une opération à cette gamme de maintenance.
          </p>
        </div>
